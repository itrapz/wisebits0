...
class CountryService
{
    ...
    {
        // Если запись есть в первичном кэше - забираем стату оттуда, регулируем время жизни с помощью TTL в конфиге (как бы слейв)
        ...
        // Если запись есть в запасном кэше - забираем стату из него => отвечаем => и асинхронно пишем в оба кэша фоном с помощью очередей,
